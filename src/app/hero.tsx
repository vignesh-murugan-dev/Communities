...
const Hero = () => {
  ...
  return (
    <>
      <div className={`absolute inset-0 z-0 w-[350px] h-[350px] md:w-[406px] md:h-[406px] bg-[#7eff5f]/75 rounded-full blur-[200px] translate-x-[40px] translate-y-[120px] md:translate-x-[440px] md:translate-y-[120px]`} />
