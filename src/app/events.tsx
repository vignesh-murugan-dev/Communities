...
const Events = () => {
    const EventCard = ({ communityname, title, date, location, venue }) => (
    ...
    return (
        <main className="p-4 mx-4 md:mx-8 lg:mx-16 bg-white  rounded-xl">
            <section>
                <h2 className="text-lg font-normal mb-3"><span className='text-black font-black text-[30px]'>this month</span></h2>
            ...
            <h2 className="text-lg font-normal mb-3"><span className='text-black font-black text-[30px]'>upcoming</span></h2>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
